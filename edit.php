<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET"){
        ...
        $sql = "SELECT * FROM zapisky WHERE id=$id";
        ...
        do{
            if (empty($id) ||empty($jmeno) || empty($vaha) || empty($pocet)){
                $errorMessage = "Vyplňte všechny pole";
                break;
            }
            $sql = "UPDATE zapisky " . 
                    "SET jmeno = '$jmeno', vaha = '$vaha', pocet = '$pocet' " .
                    "WHERE id = $id";
            ...
            $succesMessage = "Záznam byl úspěšně zeditován";
